...
> 
> As this editor project is mainly targeted at Chinese-speaking users (using Pinyin input), it is not directly adaptable to other languages. However, if you are fascinated by the idea, feel free to leave an issue or fork the project.
